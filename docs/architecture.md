...
| 2026-09-17 | Amplify app was deleted and recreated as GitHub-connected from the start — new live URL is https://main.d3i4xcsmv7sca9.amplifyapp.com | Replaced initial CLI zip-deployment scaffolding with a clean Git-connected CI/CD Amplify hosting setup connected directly to the repository main branch. |
